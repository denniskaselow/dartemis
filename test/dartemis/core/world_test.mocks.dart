...
class _FakeWorld_0 extends _i1.Fake implements _i2.World {}
...
class MockEntitySystem2 extends _i1.Mock implements _i2.EntitySystem {
  @override
  bool get passive =>
      (super.noSuchMethod(Invocation.getter(#passive), returnValue: false)
          as bool);
  @override
  int get group =>
      (super.noSuchMethod(Invocation.getter(#group), returnValue: 0) as int);
  @override
  _i2.World get world => (super.noSuchMethod(Invocation.getter(#world),
      returnValue: _FakeWorld_0()) as _i2.World);
  @override
  int get frame =>
      (super.noSuchMethod(Invocation.getter(#frame), returnValue: 0) as int);
  @override
  double get time =>
      (super.noSuchMethod(Invocation.getter(#time), returnValue: 0.0)
          as double);
  @override
...
class MockComponentManager extends _i1.Mock implements _i2.ComponentManager {
  ...
  List<_i2.Component> getComponentsFor(int? entity) =>
      (super.noSuchMethod(Invocation.method(#getComponentsFor, [entity]),
          returnValue: <_i2.Component>[]) as List<_i2.Component>);
  @override
